...
import NumberGuessGame from "./NumberGuessGame"; // import game
...
const PREDEFINED_QA: { q: string; a: string }[] = [
  {
    ...
    a: "I can help you design UI, write code, debug issues, and brainstorm ideas.",
  },
  {
    q: "How do I structure a React app?",
    a: "Break it into reusable components, colocate logic, and keep state close to where it's used.",
  },
  {
    q: "What is glassmorphism?",
    a: "A UI style using translucent surfaces, blur, subtle borders, and soft glows for depth.",
  },
  {
    q: "How do I improve UX?",
    a: "Focus on clarity, feedback, accessibility, and smooth micro-interactions.",
  },
  {
    q: "Best practices for TypeScript?",
    a: "Use strict types, define interfaces for data, and avoid any whenever possible.",
  },
  {
    q: "How to animate UI smoothly?",
    a: "Use Framer Motion for layout and presence animations with easing and staggered transitions.",
  },
  {
    q: "How to manage forms in React?",
    a: "Use controlled inputs, validate early, and provide instant feedback.",
  },
  {
    q: "What makes a UI feel premium?",
    a: "Consistent spacing, soft shadows, subtle glows, smooth animations, and thoughtful colors.",
  },
];
...
export default function Page({
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-zinc-950 via-slate-900 to-zinc-950 text-white flex items-center justify-center p-4">
      <div className="relative w-full max-w-4xl h-[90vh] rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl shadow-cyan-500/10  flex flex-col">
        {/* Header */}
        <div className="p-4 border-b border-white/10 flex items-center gap-3">
          ...
          <button
            ...
            className="ml-auto px-3 py-1 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 text-xs transition"
          >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {showGame ? (
            ...
            <>
              ...
              <div
                ref={scrollRef}
                className="flex-1 overflow-y-auto p-4 space-y-3 hide-scroll-bar"
              >
